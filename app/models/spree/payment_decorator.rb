Spree::Payment.class_eval do
  ...
  def email_to_provider_if_payment
    if (self.state.changed? || self.state == "completed" || self.payment.payment_method_id == 2)
      begin
        ...
        @suppliers.each do |supplier|
          ...
          Spree::NotifyMailer.send_email_to_provider(self.order, @line_items).deliver unless @line_items.empty?
        end
      rescue Exception => e
